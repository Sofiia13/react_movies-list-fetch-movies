...
API key = `http://www.omdbapi.com/?i=tt3896198&apikey=90f8e14f`;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Sofiia13.github.io/react_movies-list-fetch-movies/) and add it to the PR description.
